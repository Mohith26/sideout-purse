...
/**
 * Zod schemas for the v1 resources the ladder reads (spec 4.7), each held to the matching
 ...
 * decimal string (`Money`); nothing here turns an amount into a JavaScript number. The
 * same file, with the same reasoning, exists in Sideout: the second consumer having to
 * restate it is one of the things this tenant exposed (docs/decisions.md).
 */
/**
