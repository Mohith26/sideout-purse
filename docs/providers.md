...
geolocation, third-party risk scoring) Purse specifies a provider seam instead of
...
platform's own velocity figures. Nothing that crosses a seam is a document, an image or a
