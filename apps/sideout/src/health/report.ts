 ...
 * last reconcile failed, is reported in `purse` and never turns Sideout's own answer into
 * an error: this endpoint is Sideout's health, and the hosted deploy's health check and
