 ...
 * secret key and the variable that holds one, and the office code's variable. A hit fails
 * the build. Runs as the second half of `pnpm --filter @pingpong/web build`.
 */
const FORBIDDEN = [
  ...
  { name: 'the OFFICE_CODE variable', pattern: /OFFICE_CODE/ },
];
